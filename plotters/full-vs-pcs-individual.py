...
os.makedirs('plots/full-vs-pcs', exist_ok=True) # ENSURED full path for plots
...
create_individual_subject_plots(data_df, regions, layer_order, dataset_name, metric_name) # MODIFIED CALL 