...
if __name__ == '__main__':
    ...
    plot_best_coarse_vs_1k(summary, REGIONS, 'plotters/post-neurips/tvsd_best_coarse_vs_1k.png')
    plot_all_granularities(summary, REGIONS, 'plotters/post-neurips/tvsd_all_granularities_by_region.png')
