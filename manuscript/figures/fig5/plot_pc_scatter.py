...
Usage (from project root):
    python manuscript/figures/fig5/plot_pc_scatter.py                    # PCA, fc1 (default)
    python manuscript/figures/fig5/plot_pc_scatter.py --layer fc2        # PCA, fc2
    python manuscript/figures/fig5/plot_pc_scatter.py --method umap      # UMAP, fc1
    python manuscript/figures/fig5/plot_pc_scatter.py --no-behavioral    # model panels only
"""
