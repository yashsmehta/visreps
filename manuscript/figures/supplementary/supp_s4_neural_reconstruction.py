"""Supplementary Figure S4: Neural Reconstruction Analysis.

Reconstruction control: alignment (Spearman ρ) vs. number of PCs retained
(top-k) for the best coarse model vs. 1000-way, across all neural
dataset–region pairs.

Layout: 2×3 grid
  Row 0: TVSD V1 | TVSD V4 | TVSD IT
  Row 1: NSD Early | NSD Ventral | (empty or THINGS)

THINGS reconstruction is shown in main Figure 4A; this figure covers
the neural datasets that were removed from the main figures.
...
OUTPUT = "manuscript/figures/supplementary/supp_s4_neural_reconstruction.png"

# Best coarse model per region (from results.db: reconstruct_from_pcs=1)
# Maps region -> (cfg_id, checkpoint_dir)
RECON_CONFIGS = {
    "tvsd": {
