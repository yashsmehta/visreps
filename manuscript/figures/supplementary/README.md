...
| ~~**S13**~~ | *(Moved to Figure 4C)* | `manuscript/figures/fig5/dimension_profiling.py` | — |
...
| **S18** | Class-Level RDM Grid | `supp_s18_class_rdms.py` | Class-level RDMs across all granularity levels (2,4,8,16,32,64,1000-way). Moved from old main Figure 2A; supplementary version includes all levels. |
...
# S13 moved to main Figure 4C: python manuscript/figures/fig5/dimension_profiling.py
...
python manuscript/figures/supplementary/supp_s18_class_rdms.py
