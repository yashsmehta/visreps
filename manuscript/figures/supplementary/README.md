...
| ~~**S13**~~ | *(Moved to Figure 4C)* | `manuscript/figures/fig4/dimension_profiling.py` | — |
...
# S13 moved to main Figure 4C: python manuscript/figures/fig4/dimension_profiling.py
