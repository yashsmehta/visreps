#!/usr/bin/env python3
"""Extract representations from DINOv3 (self-supervised ViT)."""
...
def main():
    ...
    print(f"Loaded DINOv3 on {device}")
    ...
    features, image_names = extract_features(
        ...
        device=device,
        desc="Extracting DINOv3"
    )
    save_features(features, image_names, args.dataset, "dino")
